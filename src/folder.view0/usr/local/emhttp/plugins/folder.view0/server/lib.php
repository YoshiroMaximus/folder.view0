<?php
    ...
    $fv2_debug_log_file = "/tmp/folder_view0_php_debug.log"; 
    ...
    if (FV2_DEBUG_MODE && isset($_GET['type']) && basename($_SERVER['SCRIPT_NAME']) === 'read_info.php') {
        @file_put_contents($fv2_debug_log_file, "--- FolderView0 lib.php readInfo Start ---\n");
    }

    $folderVersion = 1.0;
    $configDir = "/boot/config/plugins/folder.view0";
    $sourceDir = "/usr/local/emhttp/plugins/folder.view0";
